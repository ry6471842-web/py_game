    ...
    while True:
        ...
        if amount.isdigit():
            ...
            if amount > 0:
                ...
                print("Amount must be a value greater than 0.")
        else:
...
def spin(balance):
    ...
    while True:
        ...
        if total_bet > balance:
            print(f"You do not have enough funds to place that bet. Your balance is ${balance}")
        else:
            break
    ...
    slot_machine = get_slot_machine_spin(ROWS, COLS, symbols_count)
